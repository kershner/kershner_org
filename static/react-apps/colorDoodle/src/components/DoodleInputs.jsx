...
function DoodleSelect(props) {
    ...
    return (
        <select name={inputProps.name} onChange={inputProps.handleChange} value={inputProps.defaultValue} disabled={inputProps.disabled}>
            {options}
        </select>
    )
}
...
export function GithubButton() {
    function handleClick(e) {
        window.location.href = "https://github.com/kershner/kershner_org/tree/master/apps/color_doodle";
    }
